...
impl Woff2CampSubTable0 {
    pub fn setFormat(self: &mut Woff2CampSubTable0, val: u16) {
        self.format = val;
    }
...
pub fn subtableType0(subtable: &mut Woff2CampSubTable0, buf: &Vec<u8>) -> bool {
...
pub fn subtableType2(subtable: &mut Woff2CampSubTable2, buf: &Vec<u8>) -> bool {
    // let mut cnt: usize = subtable.src_offset as usize + 2;
...
pub fn subtableType4(subtable: &mut Woff2CampSubTable4, buf: &Vec<u8>) -> bool {
    // let mut cnt: usize = subtable.src_offset as usize + 2;
...
pub fn subtableType6(subtable: &mut Woff2CampSubTable6, buf: &Vec<u8>) -> bool {
    // let mut cnt: usize = subtable.src_offset as usize + 2;
...
pub fn subtableType8(subtable: &mut Woff2CampSubTable8, buf: &Vec<u8>) -> bool {
    // let mut cnt: usize = subtable.src_offset as usize + 2;
...
pub fn subtableType10(subtable: &mut Woff2CampSubTable10, buf: &Vec<u8>) -> bool {
    // let mut cnt: usize = subtable.src_offset as usize + 2;
...
pub fn subtableType12(subtable: &mut Woff2CampSubTable12, buf: &Vec<u8>) -> bool {
    // let mut cnt: usize = subtable.src_offset as usize + 2;
...
pub fn subtableType13(subtable: &mut Woff2CampSubTable13, buf: &Vec<u8>) -> bool {
    // let mut cnt: usize = subtable.src_offset as usize + 2;
...
pub fn subtableType14(subtable: &mut Woff2CampSubTable14, buf: &Vec<u8>) -> bool {
    // let mut cnt: usize = subtable.src_offset as usize + 2;
